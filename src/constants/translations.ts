...
export const translations: Dictionary = {
  ...
  sortDate: { ja: '開催日順', en: 'Event Date' },
  sortFeatured: { ja: 'おすすめ順', en: 'Recommended' },
  sortNewest: { ja: '新着順', en: 'Newest' },
  sortTitle: { ja: '公演名順', en: 'Title' },

  // Timing Status Badges
  statusOngoing: { ja: '開催中', en: 'Ongoing' },
  ...
  genre_dance: { ja: 'ダンス・舞踊', en: 'Dance & Physical' },
  genre_music: { ja: '音楽・ライブ', en: 'Music & Live' },
  genre_theater: { ja: '演劇・パフォーマンス', en: 'Theater & Performance' },
  genre_traditional: { ja: '伝統芸能・古典', en: 'Traditional Arts' },
  genre_kamishibai: { ja: '紙芝居・語り', en: 'Kamishibai & Story' },
  genre_exhibition: { ja: '展示・アート', en: 'Exhibition & Art' },
  ...
  // Venues Date Filter
  venueFilterToday: { ja: '今日', en: 'Today' },
  venueFilterTomorrow: { ja: '明日', en: 'Tomorrow' },
  venueFilterPickDate: { ja: '日付を選ぶ', en: 'Pick a Date' },
  venueFilterAllDates: { ja: 'すべての日程', en: 'All Dates' },
  ...
  // Donation CTAs (Top Hero, Mid-page, Mobile Sticky)
  heroDonateButton: { ja: '500円から寄付する', en: 'Donate from ¥500' },
  heroReadImpactLink: { ja: '寄付の使い道を読む', en: 'See how your support helps' },
  heroSecurePaymentNote: { ja: 'クレジットカードで安全にお手続きいただけます', en: 'Secure payment by credit card' },
  midDonateTitle: { ja: 'この活動を応援する', en: 'Support this project' },
  midDonateDesc: { ja: '500円から、任意の金額でご支援いただけます。', en: 'Choose any amount from ¥500.' },
  midDonateButton: { ja: 'Osaka Fringeを応援する', en: 'Support Osaka Fringe' },
