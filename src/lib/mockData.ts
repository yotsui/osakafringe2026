...
export const mockPerformances: Performance[] = [
  {
    ...
    artistOrigin: '大阪市 / 日本',
    artistOriginEn: 'Osaka / Japan',
    artistProfile: '大阪を拠点に先鋭的なフィジカルシアターと伝統芸能の解体再構築を行う実験劇団。',
    artistProfileEn: 'An experimental theater troupe based in Osaka.',
    artistWebsite: 'https://osakafringe.com',
    genre: 'theater',
    ...
    venueArea: '中崎町',
    venueAreaEn: 'Nakazakicho',
    venueAddress: '大阪市北区中崎2-3-12',
    venueAddressEn: '2-3-12 Nakazaki, Kita-ku, Osaka',
    venueAccess: '中崎町駅 徒歩3分 / 梅田駅 徒歩12分',
    venueAccessEn: '3 min walk from Nakazakicho Station',
    venueLat: 34.7065,
    venueLng: 135.5032,
    scheduleDates: '2026-10-08 19:00, 2026-10-10 14:00, 2026-11-08 18:00',
    scheduleDatesEn: 'Oct 8 19:00, Oct 10 14:00, Nov 8 18:00',
    scheduleDetails: '10/8(木) 19:00開演 / オープニング記念公演\n10/10(土) 14:00開演\n11/8(日) 18:00開演 / グランドフィナーレ',
    schedules: [
  ...
  },
  {
    ...
    artistOrigin: 'ウクライナ・オーストラリア',
    artistOriginEn: 'Ukraine & Australia',
    artistProfile: 'エディンバラ、アデレードをはじめ世界各国のフリンジフェスティバルで最優秀ストリートパフォーマンス賞を受賞した国際デュオ。',
    artistProfileEn: 'Award-winning international circus duo performing globally.',
    genre: 'street',
    ...
    venueArea: '中之島',
    venueAreaEn: 'Nakanoshima',
    venueAddress: '大阪市北区中之島5-3-60',
    venueAddressEn: '5-3-60 Nakanoshima, Kita-ku, Osaka',
    venueAccess: '中之島駅 直結 / 福島駅 徒歩10分',
    venueAccessEn: 'Directly connected to Nakanoshima Station',
    venueLat: 34.6937,
    venueLng: 135.5042,
    scheduleDates: '2026-10-08 17:30, 2026-10-17 16:00, 2026-11-01 15:00',
    scheduleDatesEn: 'Oct 8 17:30, Oct 17 16:00, Nov 1 15:00',
    schedules: [
  ...
  },
  {
    ...
    artistOrigin: '大阪 / 日本',
    artistOriginEn: 'Osaka / Japan',
    artistProfile: '大阪在住のバイリンガルコメディアンたちによるスタンドアップコメディ集団。',
    artistProfileEn: 'A bilingual stand-up comedy collective exploring Osaka culture.',
    genre: 'dance',
    ...
    venueArea: '心斎橋',
    venueAreaEn: 'Shinsaibashi',
    venueAddress: '大阪市中央区西心斎橋1-6-14',
    venueAddressEn: '1-6-14 Nishi-Shinsaibashi, Chuo-ku, Osaka',
    venueAccess: '心斎橋駅 7番出口 徒歩2分 / なんば駅 徒歩8分',
    venueAccessEn: '2 min walk from Shinsaibashi Station Exit 7',
    venueLat: 34.6722,
    venueLng: 135.4983,
    scheduleDates: '2026-10-11 19:30, 2026-10-24 15:00',
    scheduleDatesEn: 'Oct 11 19:30, Oct 24 15:00',
    schedules: [
  ...
  },
  {
    ...
    artistNameEn: 'Sakuya',
    artistOrigin: '京都・大阪 / 日本',
    artistOriginEn: 'Kyoto & Osaka / Japan',
    artistProfile: '伝統的な上方舞と現代三味線の奏者によるコラボレーションユニット。',
    artistProfileEn: 'A collaboration unit between classical Kamigata dance masters and contemporary shamisen players.',
    genre: 'traditional',
    ...
    venueArea: '天王寺',
    venueAreaEn: 'Tennoji',
    venueAddress: '大阪市天王寺区茶臼山町1-8',
    venueAddressEn: '1-8 Chausuyamacho, Tennoji-ku, Osaka',
    venueAccess: '天王寺駅 徒歩5分 / 阿倍野駅 徒歩8分',
    venueAccessEn: '5 min walk from Tennoji Station',
    venueLat: 34.6515,
    venueLng: 135.5135,
    scheduleDates: '2026-10-18 17:00, 2026-11-03 17:30',
    scheduleDatesEn: 'Oct 18 17:00, Nov 3 17:30',
    schedules: [
  ...
  },
  {
    ...
    artistOrigin: '大阪 / 日本',
    artistOriginEn: 'Osaka / Japan',
    artistProfile: '昭和レトロな自転車紙芝居を現代に蘇らせる街頭紙芝居師。',
    artistProfileEn: 'Interactive picture storytelling artists performing from vintage bicycle carts.',
    genre: 'kamishibai',
    ...
    venueLat: 34.6937,
    venueLng: 135.5042,
    scheduleDates: '2026-10-10 13:00, 2026-10-25 13:00',
    scheduleDatesEn: 'Oct 10 13:00, Oct 25 13:00',
    schedules: [
  ...
  },
  {
    ...
    artistOrigin: '大阪・ベルリン',
    artistOriginEn: 'Osaka & Berlin',
    artistProfile: '大阪とベルリンを拠点に、水・音・光の相互作用を探求するメディアアートコレクティブ。',
    artistProfileEn: 'An international media art collective exploring water dynamics.',
    genre: 'exhibition',
    ...
    venueLat: 34.6937,
    venueLng: 135.5042,
    scheduleDates: '2026-10-08 11:00, 2026-11-08 11:00',
    scheduleDatesEn: 'Oct 8 11:00, Nov 8 11:00',
    schedules: [
